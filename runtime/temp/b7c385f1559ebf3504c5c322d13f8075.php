<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:42:"./template/admin/default\role\roleadd.html";i:1490174351;s:43:"./template/admin/default\public\header.html";i:1489988957;s:43:"./template/admin/default\public\footer.html";i:1489988957;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    ...
    <form class="layui-form">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input class="layui-input" type="text" name="title" placeholder="输入角色名称"  lay-verify="title">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                <button class="layui-btn" lay-submit="" lay-filter="add-role" data-href="<?php echo url('roleAdd'); ?>">立即提交</button>

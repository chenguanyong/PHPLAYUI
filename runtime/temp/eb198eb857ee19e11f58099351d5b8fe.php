<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:46:"./template/admin/default\article\add_cate.html";i:1489988957;s:43:"./template/admin/default\public\header.html";i:1489988957;s:43:"./template/admin/default\public\footer.html";i:1489988957;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    ...
    <form class="layui-form" action="add_article">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input class="layui-input" type="text" name="cate_name" placeholder="输入分类名称"  lay-verify="title">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">排序</label>
            <div class="layui-input-inline">
                <input class="layui-input" type="text" name="sort" placeholder="排序"  lay-verify="number">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                <button class="layui-btn" lay-submit="" lay-filter="add-role" data-href="<?php echo url('add_cate'); ?>">立即提交</button>

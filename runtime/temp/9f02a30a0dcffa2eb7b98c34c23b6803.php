<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:47:"./template/admin/default\dictionaries\list.html";i:1490841166;s:43:"./template/admin/default\public\header.html";i:1489988957;s:43:"./template/admin/default\public\footer.html";i:1489988957;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
function adddic(){
	...
	parent.location.href=$('#add').attr('data-href');
                        ...
                        <a href="javascript:;" id="add" class="layui-btn layui-btn-small " data-id=<?php echo $val; ?> data-what=<?php echo $content; ?>  data-href="/index.php/admin/Dictionaries/addDic?id=<?php echo $val; ?>"><i class="fa fa-plus"></i>添加字典</a>
    ...
    <form  class="layui-form layui-form-pane" id="formrec" method="post" role="form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="nodename" autocomplete="off"  placeholder="父节点名称" disabled="disabled" class="layui-input" type="text" required   lay-verify="title">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="bianma" autocomplete="off"  placeholder="输入编码" class="layui-input" type="text" required   lay-verify="required">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="bz" autocomplete="off"  placeholder="输入备注" class="layui-input"  type="text">
...
//alert($(this).data('id'));
$.ajax({
    url: '<?php echo url("admin/Dictionaries/ajaxDeleDic"); ?>',
    dataType: "json",
    ...
    success: function(data){
        ...
        if(data.state == 1){
            ...
            layer.msg('成功',{icon:1,time:1500,shade: 0.1,});
           	window.location.href="/index.php/admin/dictionaries/getDicListByPage?id=<?php echo $val; ?>";
        }else{
    ...
    function giveQx(id){
       ...
       // common.Ajaxpage();
        $(document).on('click','.change_status', function () {
            ...
            var obs=$(this);
            $.ajax({
                url: '<?php echo url("admin/Dictionaries/setState"); ?>',
                dataType: "json",
                data:{'id':id},
                type: "POST",
                success: function(data){
        ...
        layui.use(['laypage', 'layer','form','common'], function(){
              ...
              $('[data-page]').on("click",function(){
              	//alert("sdf");
              	window.location.href="/index.php/admin/dictionaries/getDicListByPage?id=<?php echo $val; ?>&page="+$(this).data('page');
              });
              //自定义验证规则
              form.verify({
                  pid: function(value){
                              ...
                              success: function (data) {
                                 //if (data.state == 1) {
                                    ...
                                    //  common.layerAlertS(data.msg, '提示');
                                      parent.location.href="<?php echo url('Dictionaries/index'); ?>";
                                 // }
                                 // else {

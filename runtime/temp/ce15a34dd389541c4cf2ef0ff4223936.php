<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:53:"./template/backmanager/default/admin/index\index.html";i:1493166606;s:55:"./template/backmanager/default/admin/public\header.html";i:1493166606;s:55:"./template/backmanager/default/admin/public\footer.html";i:1493166606;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    ...
    <div class="layui-header header header-admin">
        <div class="layui-main">
            <div class="fhuaui-logo">
                <a class="logo" href="/">
                                        <img src="" alt="FhuAdmin"  width="50px" height="40px" id="oop"/>
          ...
          // alert(url);
                    $.ajax({
                        ...
                        success: function (data) {
                          ...
                          $("#aid").append(data[2]['value']);
                          $("#pay").after(data[3]['value']);                
                          $("#pid").append(data[1]['value']);

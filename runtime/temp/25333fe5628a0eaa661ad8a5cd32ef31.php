<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:54:"./template/backmanager/default/admin/index\center.html";i:1493166606;s:55:"./template/backmanager/default/admin/public\header.html";i:1493166606;s:55:"./template/backmanager/default/admin/public\footer.html";i:1493166606;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="main-wrap">
    ...
    <blockquote class="layui-elem-quote fhuaui-tip">每日进度，简要描述，放置于此 </blockquote>
    <blockquote class="layui-elem-quote fhuaui-tip">命里无时终须有，命里无时莫强求</blockquote>
        ...
        <div class="layui-field-box">
            <div class="admin-log-list clearfix">
                ...
                <div class="admin-log-span admin-log-title">
                    <h2>后台管理系统</h2>
                    <p>全新视觉，简约界面乐享体验<span>|</span><a class="logck" href="javascript:;">V1.0 (点我查看功能)</a></p>
                    <div class="admin-log-content">
                        <h2>功能介绍</h2>
                        <p>1.文章管理</p>                        
                        <p>2.操作日志管理</p>
                        <p>3.系统管理,一套比较适用的权限管理系统</p>
                    </div>
                </div>

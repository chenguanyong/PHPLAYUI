<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:108:"D:\apache2.4\httpd-2.4.23-win64-VC14\Apache24\htdocs\phpace\public/../application/index\view\user\index.html";i:1489827176;}*/ ?>
			...
			<div class="panel panel-default col-xs-9" style="border:#000 0px solid; padding:2px">
				...
				<div class="panel panel-default">
                        ...
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 归属公司 </label>
                                 <div class="input-group">
                                  ...
                                  <input type="text" class="form-contro3" placeholder="Username" aria-describedby="basic-addon1">
                                </div> 
                                </div> 
                                <div class="col-xs-5">
				...
				<div class="col-xs-5">
										<div class="clearfix">
											...
											<button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#myModal" data-whatever="修改用户">修改</button>
											<button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#myModal" data-whatever="新增用户">添加</button>
											<button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#myModal" data-whatever="删除用户">删除</button>
	...
	<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
		      <tr>
		         ...
		         <td class="width-35"><input id="nameImage" name="photo" maxlength="255" class="input-xlarge" type="hidden" value="">						

<ol id="nameImagePreview"><li style="list-style:none;padding-top:5px;">无</li></ol><a href="javascript:" onclick="nameImageFinderOpen();" class="btn btn-primary">选择</a>&nbsp;<a href="javascript:" onclick="nameImageDelAll();" class="btn btn-default">清除</a>
</td>
	...
	<div class="input-group">
		<input id="companyName" name="company.name" readonly="readonly" type="text" value="河南省投资促进局" data-msg-required="" class="form-control required" style="" aria-required="true">
       		 <span class="input-group-btn">
	       		 <button type="button" id="companyButton" class="btn   btn-primary  " data-toggle="modal" data-target="#myModal2" data-whatever="#companyName"><i class="fa fa-search"></i>
	             </button> 
       		 </span>
	...
	<div class="input-group">
		<input id="officeName" name="office.name" readonly="readonly" type="text" value="河南省投资促进局" data-msg-required="" class="form-control required" style="" aria-required="true">
       		 <span class="input-group-btn">
	       		 <button type="button" id="officeButton" class="btn   btn-primary  " data-toggle="modal" data-target="#myModal2" data-whatever="#officeName" ><i class="fa fa-search"></i>
	             </button> 
       		 </span>
	 ...
	 <label id="officeName-error" class="error" for="officeName" style="display:none"></label>
		      ...
		      <tr>
		         ...
		         <td><input id="oldLoginName" name="oldLoginName" type="hidden" value="">
					 <input id="loginName" name="loginName" class="form-control required userName error" type="text" value="" maxlength="50" aria-required="true" aria-invalid="true"><label id="loginName-error" class="error" for="loginName">这是必填字段</label></td>
		      </tr>
		      
		      
		      <tr>
		         <td class="active"><label class="pull-right"><font color="red">*</font>密码:</label></td>
		         <td><input id="newPassword" name="newPassword" type="password" value="" maxlength="50" minlength="3" class="form-control required" aria-required="true">
					</td>
		      ...
		      <tr>
		         ...
		         <td><select id="userType" name="userType" class="form-control">
					<option value="" selected="selected">请选择</option>
						<option value="1">系统管理</option><option value="2">部门经理</option><option value="3">普通用户</option>
					</select></td>
		         <td class="active"><label class="pull-right"><font color="red">*</font>用户角色:</label></td>
		         <td>
		         	<span><div class="icheckbox_square-green" style="position: relative;"><input id="roleIdList1" name="roleIdList" class="i-checks required" type="checkbox" value="5" aria-required="true" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div><label for="roleIdList1" class="">本部门管理员1</label></span><span><div class="icheckbox_square-green" style="position: relative;"><input id="roleIdList2" name="roleIdList" class="i-checks required" type="checkbox" value="1c54e003c1fc4dcd9b087ef8d48abac3" aria-required="true" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div><label for="roleIdList2">管理员</label></span><span><div class="icheckbox_square-green" style="position: relative;"><input id="roleIdList3" name="roleIdList" class="i-checks required" type="checkbox" value="caacf61017114120bcf7bf1049b6d4c3" aria-required="true" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div><label for="roleIdList3">部门管理员</label></span><span><div class="icheckbox_square-green" style="position: relative;"><input id="roleIdList4" name="roleIdList" class="i-checks required" type="checkbox" value="781acb2361244e49aef509c8688c3ec2" aria-required="true" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div><label for="roleIdList4" class="">投资促进局</label></span><input type="hidden" name="_roleIdList" value="on">
		       ...
		       <tr>
		         ...
		         <td><textarea id="remarks" name="remarks" maxlength="200" class="form-control" rows="3"></textarea></td>
			...
			<div class="modal-footer">
					<button data-bb-handler="cancel" type="button" data-dismiss="modal" class="btn btn-default">关闭</button>
					<button data-bb-handler="confirm" id="sure_button" type="button" class="btn btn-primary">确定</button>
			</div>
		</div>
	</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" id='depart' data-tree='' data-value='' class="btn btn-primary">确定</button>
      </div>
    </div>
  </div>
</div>
<div class="col-sm-6">
	...
	<a  id="id-btn-dialog1" >Modal Dialog</a>
<a  id="id-btn-dialog2" >Modal Dialog</a>	
...
var remarks =	$('#remarks').val();//备注
	$.post('<?php echo \think\Config::get('__PUBLIC__'); ?>/index/User/editUser',{companyID:companyID,officeNameID:officeNameID,
...
$('#myModal').on('show.bs.modal', function (event) {
  ...
  modal.find('.modal-title').text(recipient);
				...
				$("#bootbox-regular").on(ace.click_event, function() {
					bootbox.prompt("We?", function(result) {
						if (result === null) {
	...
	$('.page-content-area').ace_ajax('loadScripts', scripts, function() {
	  //inline scripts related to this page
		...
		.DataTable( {
            ...
            { "data": "UserName" ,"title": "登录名","orderable":      false, },
            { "data": "Name" ,"title": "姓名","orderable":      false,},
            { "data": "phone" ,"title": "电话","orderable":      false,},
            { "data": "moblie" ,"title": "手机","orderable":      false,},
            { "data": "CompanyName" ,"title": "归属公司","orderable":      false,},
            { "data": "DeparName" ,"title": "归属部门","orderable":      false,},{ "data": "" }
        ], 
		"columnDefs": [{
             "orderable":      false,
            "targets": 0,
        ...
        },
		{
            ...
            "targets": 7,
			"data":null,
			 "defaultContent": "<a href='#' class='btn btn-info btn-xs'><i class='fa fa-search-plus'></i> 查看</a><a href='#' class='btn btn-success btn-xs'><i class='fa fa-edit'></i> 修改</a><a href='#'  class='btn btn-danger btn-xs'><i class='fa fa-trash'></i> 删除</a>"
        }
		...
		"drawCallback": function(settings) {
			...
			"bProcessing": true,
	        "bServerSide": true,
	        "sAjaxSource": "<?php echo \think\Config::get('__PUBLIC__'); ?>/index/User/getUserByDepartID?id=0",

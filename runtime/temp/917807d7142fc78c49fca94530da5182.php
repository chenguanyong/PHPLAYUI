<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:40:"./template/admin/default\image\list.html";i:1490854844;s:43:"./template/admin/default\public\header.html";i:1489988957;s:43:"./template/admin/default\public\footer.html";i:1489988957;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
function adddic(){
	...
	parent.location.href=$('#add').attr('data-href');
                        ...
                        <a href="javascript:;" id="add" class="layui-btn layui-btn-small "  onclick='adddic()' data-href="/index.php/admin/Image/addImage?id=<?php echo $nodeID; ?>"><i class="fa fa-plus"></i>添加图片</a>
...
//alert($(this).data('id'));
$.ajax({
    url: '<?php echo url("admin/Image/ajaxDeleImage"); ?>',
    dataType: "json",
    ...
    success: function(data){
        ...
        if(data.state == 1){
            ...
            layer.msg('成功',{icon:1,time:1500,shade: 0.1,});
           	window.location.href="/index.php/admin/Image/getImageListByPage?id=<?php echo $val; ?>";
        }else{
    ...
    error:function(ajaxobj)
    {
        ...
        layui.use(['laypage', 'layer'], function(){
              ...
              $('[data-page]').on("click",function(){
              	//alert("sdf");
              	window.location.href="/index.php/admin/Image/getImageListByPage?id=<?php echo $val; ?>&page="+$(this).data('page');
              });
        	  });
                              ...
                              success: function (data) {
                                 if (data.state == 1) {
                                     // location.href = rturl;
                                      ...
                                      parent.location.href="<?php echo url('Image/index'); ?>";
                                  }
                                  else {

layui.config({
    base: "/public/statisc/layui/lay/modules/extendplus/"
}).extend({
...
layui.use(["layer", "element", "util", "common"], function() {
    ...
    var g = {
            ...
            doDelete: function() {
                var b = a(this).data("href");
                if (b) {
                    if (1 > a(".layui-table tbody input:checked").size()) return common.layerAlertE("对不起，请选中您要操作的记录！", "提示");
                    for (var c = "", d = a(".layui-table tbody input:checked"), e = 0; e < d.length; e++) d[e].checked && "disabled" != a(d[e]).attr("disabled") && (c += a(d[e]).attr("ids") + ",");
